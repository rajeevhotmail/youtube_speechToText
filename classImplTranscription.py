    ...
    def process_stream(self, stream_url):
        while not self.stop_event.is_set():
            ...
            try:
                ...
                transcription = self.transcribe_audio(wav_segment)
                if transcription:
                    # Translate the transcription to English
                    translation = self.translate_text(transcription, 'en')
                    message = f"Original: {transcription}\nEnglish: {translation}\n"
...
def main():
    VIDEO_ID = "IwcAfOVfqVs"  # Replace with your YouTube video ID
